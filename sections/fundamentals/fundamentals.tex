...
Somit stellt in den meisten Fällen erst die Kombination aus mehreren Bedrohungen ein potentielles Risiko für den Nutzer dar. Beispielsweise entsteht durch die Gefahr \fullref{sec:Grundlagen:para:User Identification} zu Beginn keine für den Benutzer feststellbare Implikation. 
...
Ohne diesen Schritt wäre beispielsweise ein \fullref{sec:Grundlagen:para:Profiling} oder ein \fullref{sec:Grundlagen:para:Identity Theft} nicht möglich. 
