...
%\begin{figure}
%    \centering
%    \includegraphics[scale=0.2]{main/pictures/countermeasures/Identification_Non_Essential_Traffic}
...
\paragraph{TODO: IoTInspector oder Smart Walk in Hamburg} % Application Layer
